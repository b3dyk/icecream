...
var _slick = require("./js/slick");
var _gallery = require("./js/gallery");
var _menu = require("./js/menu");

},{"./js/modal":"aHHgN","./js/slick":"5GXNQ","./js/menu":"dTgwB","./js/gallery":"iXSQ6"}],"aHHgN":[function(require,module,exports) {
...
if (window.matchMedia("(min-width: 1200px)").matches) $(".grid").masonry({
    gutter: 8
});
else if (window.matchMedia("(min-width: 768px)").matches) $(".grid").masonry({
    gutter: 6
});
else if (window.matchMedia("(max-width: 767px)").matches) $(".grid").masonry({
    gutter: 2
});
...
},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequire1028")
